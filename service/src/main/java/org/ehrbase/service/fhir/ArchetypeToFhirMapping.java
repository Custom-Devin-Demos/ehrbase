 ...
 *
 * <ul>
 *   <li>{@code OBSERVATION} → {@link ResourceType#Observation}
 *   <li>{@code EVALUATION} → {@link ResourceType#Condition}
 *   <li>{@code INSTRUCTION} → {@link ResourceType#MedicationRequest}
 *   <li>{@code ACTION} → {@link ResourceType#MedicationStatement} (or {@link ResourceType#Procedure})
 *   <li>{@code ADMIN_ENTRY} → {@link ResourceType#Encounter}
 * </ul>
 */
public final class ArchetypeToFhirMapping {

    /** Default RM-type-name → FHIR ResourceType mapping. */
     ...
     *
     * @return an unmodifiable map of RM type name → FHIR ResourceType
     */
