...
import org.ehrbase.rest.fhir.provider.EhrbaseFhirCapabilityStatementProvider;
...
public class FhirServletConfiguration {
    ...
    public ServletRegistrationBean<RestfulServer> fhirServletRegistration(
            ...
            EhrbaseFhirCapabilityStatementProvider capabilityStatementProvider,
            PatientResourceProvider patientProvider,
            ObservationResourceProvider observationProvider,
            ConditionResourceProvider conditionProvider,
            BundleResourceProvider bundleProvider) {
